export type Marketplace = {
    ...
    errors: [
        ...
        {
            code: 6024;
            name: 'InvalidProgramDerivedAccount';
            msg: 'Invalid Program Derived Account';
        },
        {
            code: 6025;
            name: 'MissingRequiredAccount';
            msg: 'A required account is missing';
        }
    ];
};
export declare const IDL: Marketplace;
