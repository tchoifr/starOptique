...
exports.getSimulationUnits = exports.DEFAULT_COMPUTE_UNIT_LIMIT = exports.COMPUTE_TEST_INSTRUCTIONS = exports.COMPUTE_TEST_INSTRUCTION_RETURNS = void 0;
...
exports.DEFAULT_COMPUTE_UNIT_LIMIT = 500000;
...
const getSimulationUnits = (transaction, connection) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (simulation.value.err) {
            return exports.DEFAULT_COMPUTE_UNIT_LIMIT;
        }
 ...
 */
function buildAndSignOptimalTransaction(connection_1, instructions_1, feePayer_1, priorityConfig_1) {
    return __awaiter(this, arguments, void 0, function* (connection, instructions, feePayer, priorityConfig, lookupTables = []) {
        var _a;
 ...
 */
function buildOptimalDynamicTransactions(connection_1, instructions_1, feePayer_1, priorityConfig_1) {
    return __awaiter(this, arguments, void 0, function* (connection, instructions, feePayer, priorityConfig, lookupTables = [], beforeIxs, afterIxs, maxInstructionCount = 64) {
 ...
 */
function buildOptimalDynamicTransactionsNoSigning(connection_1, instructions_1, feePayer_1, priorityConfig_1) {
    return __awaiter(this, arguments, void 0, function* (connection, instructions, feePayer, priorityConfig, lookupTables = [], beforeIxs, afterIxs, maxInstructionCount = 64) {
        const testBeforeIxs = [
            ...exports.COMPUTE_TEST_INSTRUCTION_RETURNS,
        ...
        const getIxWithComputeBudget = () => Promise.all(noSignedIxs.map((_a) => __awaiter(this, [_a], void 0, function* ({ writableKeys, simulationTransaction, instructionsWithSigners, }) {
