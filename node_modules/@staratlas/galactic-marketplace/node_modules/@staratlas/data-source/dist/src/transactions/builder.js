...
exports.TransactionBuilder = exports.TransactionBuilderCore = void 0;
...
class TransactionBuilderCore {
    ...
    handlePriorityOptimization(buildConfig_1, ignoreError_1, depth_1) {
        return __awaiter(this, arguments, void 0, function* (buildConfig, ignoreError, depth, maxDepth = 3) {
            var _a;
            if (depth > maxDepth) {
...
class TransactionBuilder extends TransactionBuilderCore {
    ...
    rebuildLast() {
        return __awaiter(this, arguments, void 0, function* (recalculatePriority = true) {
